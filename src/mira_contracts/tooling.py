...
Extracted to the public contracts package (ADR-050) — the tool-contract shape
is part of the agent-agnostic surface (envelope ``tool_grants`` reference these
entitlements). ``mira.tools.contract`` re-exports from here.
"""
